                ...
                <div class="dz-bnr-inr-entry">
                    ...
                    <nav aria-label="breadcrumb" class="breadcrumb-row">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">{{ __('Verify Your Email Address') }}</li>
                        </ul>
                    </nav>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-6 mb-4">
                        <div class="login-area">
                            <form method="POST" action="{{ route('verify.email', ['id' => $id]) }}">
                                @csrf
                                <h4 class="text-secondary">{{ __('Verify Email') }}</h4>
                                ...
                                <div class="d-sm-flex d-flex justify-content-between small mb-4">
                                    ...
                                    <a id="resendLink" class="btn btn-sm btn-link text-black p-0 text-decoration-underline mb-0">Click to resend</a>
                                </div>
