    ...
    <nav class="nav navbar navbar-expand-xl navbar-light iq-navbar border-bottom">
        <div class="container-fluid navbar-inner justify-content-between">
            <a href="index.html" class="navbar-brand">
                <!--Logo start-->
                <div class="logo-main">
                    <img class="logo-normal" src="{{ asset('admin-assets/images/logo.png') }}" height="30" alt="logo">
                    <img class="logo-color" src="{{ asset('admin-assets/images/logo-white.png') }}" height="30" alt="logo">
                    <img class="logo-mini" src="{{ asset('admin-assets/images/logo-mini.png') }}" alt="logo">
                    <img class="logo-mini-white" src="{{ asset('admin-assets/images/logo-mini-white.png') }}" alt="logo">
                </div>
                <!--logo End-->
            </a>
                                ...
                                <div class="p-0 card-body">
                                    <a href="#" class="iq-sub-card">
                                        <div class="d-flex align-items-center">
                                            <img class="avatar-40 rounded" src="{{ asset('admin-assets/images/avatars/01.jpg') }}" alt="" loading="lazy" />
                                    ...
                                    <a href="#" class="iq-sub-card">
                                        <div class="d-flex align-items-center">
                                            <img class="avatar-40 rounded" src="{{ asset('admin-assets/images/avatars/02.jpg') }}" alt="" loading="lazy" />
                                            <div class="ms-3 flex-grow-1 text-start">
                                    ...
                                    <a href="#" class="iq-sub-card">
                                        <div class="d-flex align-items-center">
                                            <img class="avatar-40 rounded" src="{{ asset('admin-assets/images/avatars/03.jpg') }}" alt="" loading="lazy" />
                                            <div class="ms-3 flex-grow-1 text-start">
                                    ...
                                    <a href="#" class="iq-sub-card">
                                        <div class="d-flex align-items-center">
                                            <img class="avatar-40 rounded" src="{{ asset('admin-assets/images/avatars/04.jpg') }}" alt="" loading="lazy" />
                                            <div class="ms-3 flex-grow-1 text-start">
                            ...
                            <div class="m-0 card-shadow card">
                                ...
                                <div class="p-0 card-body">
                                    <div class="iq-sub-card">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <img class="rounded" src="{{ asset('admin-assets/images/cart/01.jpg') }}" alt="" loading="lazy" />
                                            </div>
                                    ...
                                    <div class="iq-sub-card">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <img class="rounded" src="{{ asset('admin-assets/images/cart/02.jpg') }}" alt="" loading="lazy" />
                                            </div>
                                    ...
                                    <div class="iq-sub-card">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <img class="rounded" src="{{ asset('admin-assets/images/cart/03.jpg') }}" alt="" loading="lazy" />
                                            </div>
                                            <div class="ms-3 flex-grow-1 text-start">
                                    ...
                                    <div class="iq-sub-card">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <img class="rounded" src="{{ asset('admin-assets/images/cart/04.jpg') }}" alt="" loading="lazy" />
                                            </div>
                                            <div class="ms-3 flex-grow-1 text-start">
                           ...
                           id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <div class="icon-50">
                                <span class="btn-inner d-inline-block position-relative">
                                    <img src="{{ Auth::user()->profile && Auth::user()->profile->profile_picture ? asset('profile/' . Auth::user()->profile->profile_picture) : 'https://placehold.co/100x100/000000/FFF?text=' . substr(Auth::user()->name, 0, 1) }}"
                            ...
                            <div class="d-none d-lg-block">
                                ...
                                <p class="mb-0 text-primary lh-sm">Super Admin</p>
                            </div>
                        </a>
                            ...
                            <div class="m-0 card-shadow card">
                                ...
                                <div class="p-0 card-body">
                                    ...
                                    <div class="p-3 d-flex justify-content-center align-items-center">
                                        <a class="btn btn-primary d-flex align-items-center gap-1" href="{{ route('logout') }}" role="button" onclick="event.preventDefault(); document.getElementById('logout-form').submit()">Sign out <i class="ph ph-sign-out"></i></a>
