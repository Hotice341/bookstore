                                        ...
                                        <td>
                                            <div class="d-flex gap-1 align-items-center list-user-action">
                                                <form action="{{ route('books.restore', $book->id) }}" method="POST">
                                                    @csrf
                                                    @method('PATCH')
                                                    <button class="bg-success-subtle rounded border-0" type="submit">
                                                        Restore
                                                    </button>
                                                </form>
                                                ...
                                                <form action="{{ route('books.force.delete', $book->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button class="bg-danger-subtle rounded border-0" type="submit">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete-book', function(e) {
                ...
                const url = "{{ route('books.force.delete', ':id') }}".replace(':id', id);
