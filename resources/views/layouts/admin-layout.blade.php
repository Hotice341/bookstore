...
<html lang="en" class="theme-fs-sm" data-bs-theme-color="default" dir="ltr">
    <head>
        ...
        <title data-setting="app_name" data-rightJoin=" Book store management system">Booksto Book store management system</title>
        ...
        <!-- Favicon -->
        <link rel="shortcut icon" href="{{ asset('admin-assets/images/logo-mini.png') }}" />

        <!-- CSS Libraries -->
        <link rel="stylesheet" href="{{ asset('admin-assets/css/core/libs.min.css') }}" />
        <link rel="stylesheet" href="{{ asset('admin-assets/vendor/flaticon/css/flaticon.css') }}" />
        <link rel="stylesheet" href="{{ asset('admin-assets/vendor/font-awesome/css/font-awesome.min.css') }}" />
        <link rel="stylesheet" href="{{ asset('admin-assets/vendor/swiperSlider/swiper.min.css') }}" />
        ...
        <link rel="stylesheet" href="{{ asset('admin-assets/vendor/dripicons/webfont/webfont.css') }}" />
        <link rel="stylesheet" href="{{ asset('admin-assets/vendor/ionicons/css/ionicons.min.css') }}" />
        <link rel="stylesheet" href="{{ asset('admin-assets/vendor/line-awesome/css/line-awesome.min.css') }}" />
        <link rel="stylesheet" href="{{ asset('admin-assets/vendor/phosphor-icons/Fonts/regular/style.css') }}" />
        <link rel="stylesheet" href="{{ asset('admin-assets/vendor/phosphor-icons/Fonts/duotone/style.css') }}" />
        <link rel="stylesheet" href="{{ asset('admin-assets/vendor/phosphor-icons/Fonts/fill/style.css') }}" />

        <!-- Theme CSS -->
        <link rel="stylesheet" href="{{ asset('admin-assets/css/booksto.min5438.css?v=1.2.0') }}" />
        <link rel="stylesheet" href="{{ asset('admin-assets/css/custom.min5438.css?v=1.2.0') }}" />
        <link rel="stylesheet" href="{{ asset('admin-assets/css/rtl.min5438.css?v=1.2.0') }}" />
        <link rel="stylesheet" href="{{ asset('admin-assets/css/customizer.min5438.css?v=1.2.0') }}" />
    ...
    <body class="">
        ...
        <div id="loading">
            <div class="loader simple-loader">
                <div class="loader-body">
                    <img src="{{ asset('admin-assets/images/loader.gif') }}" alt="loader" class="light-loader img-fluid" width="200">
                </div>
            </div>
        </div>
        <!-- Loader END -->
        ...
        <!-- Sidebar -->
        @include('snippets.admin-side-bar')
        ...
        <script src="{{ asset('admin-assets/vendor/swiperSlider/swiper.min.js') }}"></script>
        ...
        <script src="{{ asset('admin-assets/js/vertical_slider.js') }}" defer></script>
        <script src="{{ asset('admin-assets/js/slider5438.js?v=1.2.0') }}" defer></script>
        <script src="{{ asset('admin-assets/js/booksto5438.js?v=1.2.0') }}" defer></script>
        <script src="{{ asset('admin-assets/js/booksto-advance5438.js?v=1.2.0') }}" defer></script>
        <script src="{{ asset('admin-assets/js/sidebar5438.js?v=1.2.0') }}" defer></script>
        <script src="{{ asset('admin-assets/js/Setting/enchanter.js') }}" defer></script>
