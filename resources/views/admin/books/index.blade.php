                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center position-relative">
                        ...
                        <div class="iq-card-header-toolbar d-flex align-items-center">
                            <a href="{{ route('books.create') }}" class="btn btn-primary view-more">Add New Book</a>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-1 align-items-center list-user-action">
                                                    <a class="bg-success-subtle rounded" data-toggle="tooltip" data-placement="top" title="Edit" href="{{ route('books.edit', $book->id) }}">
                                                        <i class="ph ph-pencil-simple text-success custom-ph-icons"></i>
                                                    </a>

                                                    <!-- Delete Button -->
                                                    <a class="bg-danger-subtle delete-book rounded cursor-pointer" data-id="{{ $book->id }}" data-toggle="tooltip" data-placement="top" title="Delete">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete-book', function(e) {
                ...
                const url = "{{ route('books.destroy', ':id') }}".replace(':id', id);
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            error: function(xhr) {
                                Swal.fire(
                                    'Error!',
                                    xhr.responseJSON.message || 'Failed to delete book.',
                                    'error'
                                );
                            }
                        });
