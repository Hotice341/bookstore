                    ...
                    <div class="card-body">
                        <form action="{{ route('categories.update', $category->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input id="name" type="text" class="form-control @error('email') is-invalid @enderror p-2 bg-white border" name="name" value="{{ old('name', $category->name) }}" autocomplete="off" autofocus placeholder="Category Name">
                            </div>
